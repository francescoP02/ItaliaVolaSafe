...
@section('content')
    {{-- Jumbotron --}}
    <div class="jumbotron jumbotron-fluid" style="background-image: url('{{asset('img/plane_bg2.jpg')}}')">
        <div class="ms-jumbotron-container d-flex">
            <div class="ms-jumbotron-text align-self-center mx-2" data-aos = "fade-left">
